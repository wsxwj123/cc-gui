...
const apiPort = Number(process.env.R126_API_PORT || 0);
const uiPort = Number(process.env.R126_UI_PORT || 0);
if (!apiPort || !uiPort) throw new Error('R126_API_PORT / R126_UI_PORT 必须先设置(run.sh 负责)');
