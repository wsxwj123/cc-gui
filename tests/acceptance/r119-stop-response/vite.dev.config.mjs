...
const apiPort = Number(process.env.R119_API_PORT || 0);
const uiPort = Number(process.env.R119_UI_PORT || 0);
if (!apiPort || !uiPort) throw new Error('R119_API_PORT / R119_UI_PORT 必须先设置(run.sh 负责)');
