...
const apiPort = Number(process.env.R123_API_PORT || 0);
const uiPort = Number(process.env.R123_UI_PORT || 0);
if (!apiPort || !uiPort) throw new Error('R123_API_PORT / R123_UI_PORT 必须先设置(run.sh 负责)');
