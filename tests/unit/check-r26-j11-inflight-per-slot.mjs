...
await writeFile(join(GUI, 'custom-providers.json'), JSON.stringify([
  { id: 'pa', name: 'A慢', type: 'openai', baseURL: 'http://127.0.0.1:6703/slow-a/v1', apiKey: 'dummy-a', models: ['m'] },
  { id: 'pb', name: 'B快', type: 'openai', baseURL: 'http://127.0.0.1:6703/fast-b/v1', apiKey: 'dummy-b', models: ['m'] },
]));
